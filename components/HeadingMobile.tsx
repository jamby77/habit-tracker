...
const HeadingMobile: React.FC = () => {
  return (
    <div className="bg-white shadow-lg flex flex-row justify-between px-4 py-2 items-center">
      <Logo />
      <button className="active:bg-none focus:outline-white w-12 h-12 flex items-center justify-center flex-grow-0 focus:ring-2 focus:ring-purple-600 focus:ring-opacity-50 rounded-full">
